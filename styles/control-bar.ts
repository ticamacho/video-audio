export const controlBarStyles = {
  ...
  buttonGroup: "border-2 rounded-2xl border-gray-300 flex overflow-hidden",
  ...
  leaveButton:
    "bg-plum-50! gap-0! border-none! px-4 text-plum-700 hover:bg-plum-100! disabled:opacity-100!",
